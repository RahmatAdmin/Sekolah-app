...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Tittle</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.set')}}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="informasi" class="nav-link" style="display: flex; gap: 10px;">
                ...
                <li class="nav-item">
                    <a href="informasi" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="nav-icon" fill="white">
